...
// UP means lowest first, DOWN means highest first
    ...
    public query(query:QueryRequest):QueryResponse {
        ...
        var courses: any[] = [
            { courses_uuid: 59643, courses_dept: 'cpsc', courses_id: '311', courses_pass: 73, courses_fail: 2}
        ];

        var rooms: any[] = [
            { rooms_fullname: 'Hebb', rooms_shortname: 'HEBB', rooms_number: '100', rooms_seats: 375 },
        ];
